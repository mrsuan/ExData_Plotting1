...
par(mfrow = c(2,2))
par(cex = 0.80)
plot(powerConsumption2$DateTime, as.numeric(as.character(powerConsumption2$Global_active_power)), type = "l", xlab="", ylab="Global Active Power")
plot(powerConsumption2$DateTime, as.numeric(as.character(powerConsumption2$Voltage)), type = "l", xlab="datetime", ylab="Voltage")
...
plot(powerConsumption2$DateTime, as.numeric(as.character(powerConsumption2$Global_reactive_power)), type = "l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
